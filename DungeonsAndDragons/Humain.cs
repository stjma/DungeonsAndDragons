...
namespace DungeonsAndDragons
{
    class Humain : Etre
    {
        ...
        public Humain(string nom) : base(nom)
        {
            ...
            _Agilite = rnd.Next(85, 125);
            _Endurance = rnd.Next(85, 125);
            _Energie = rnd.Next(85, 125);
            _Force = rnd.Next(85, 125);
            _Mana = rnd.Next(85, 125);
        }
